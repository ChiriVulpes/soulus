...
public class ModRenderers {
	...
	public static final ComposerRenderer<ComposerTileEntity> COMPOSER_RENDERER = new ComposerRenderer<>(
			ComposerTileEntity.class);
	public static final ComposerRenderer<ComposerCellTileEntity> COMPOSER_CELL_RENDERER = new ComposerRenderer<>(
			ComposerCellTileEntity.class);

	public static final List<TileEntityRenderer<? extends TileEntity>> renderers = Arrays.asList(SUMMONER_RENDERER,
			COMPOSER_RENDERER, COMPOSER_CELL_RENDERER);
