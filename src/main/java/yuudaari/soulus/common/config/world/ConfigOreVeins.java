...
public class ConfigOreVeins {
	...
	@ConfigProfile public static ConfigOreVeins enabled = new ConfigOreVeins(new OreVein[] {
		...
		new OreVein().setBlock("soulus:fossil_gravel_fungal")
			.setToReplace("minecraft:dirt")
			.setSize(3, 7)
			.setChances(300)
			.setBiomes(Type.WET, Type.DENSE),
		new OreVein().setBlock("soulus:fossil_gravel_dry")
		...
		new OreVein()
			...
			.setBiomesBlacklist(Type.NETHER),
		new OreVein()
			.setBlock("soulus:fossil_ice")
			.setToReplace("minecraft:ice")
			.setSize(3, 7)
			.setChances(300)
			.setBiomes(Type.COLD, Type.SNOWY)
			.setBiomesBlacklist(Type.NETHER),
		new OreVein()
			.setBlock("soulus:fossil_ice_ender")
			.setToReplace("minecraft:ice")
			.setSize(2, 5)
			.setChances(100)
			.setBiomes(Type.COLD, Type.SNOWY)
			.setBiomesBlacklist(Type.NETHER),
		new OreVein()
			.setBlock("soulus:fossil_ice_frozen")
			.setToReplace("minecraft:ice")
			.setSize(3, 7)
			.setChances(300)
			.setBiomes(Type.COLD, Type.SNOWY)
			.setBiomesBlacklist(Type.NETHER),
		new OreVein()
			.setBlock("soulus:fossil_ice_scale")
			.setToReplace("minecraft:ice")
			.setSize(3, 7)
			.setChances(30)
			.setBiomes(Type.COLD, Type.SNOWY)
