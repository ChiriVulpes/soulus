...
public class ItemRegistry {
	...
	public static Item DUST_NIOBIUM = new Item("dust_niobium").setHasGlint().setHasDescription();
	public static Item DUST_ENDER_IRON = new Item("dust_ender_iron").setHasGlint().setHasDescription();
	public static Item DUST_ENDER_IRON_ASHEN = new Item("dust_ender_iron_ashen").setHasDescription();
	...
	public static Item INGOT_NIOBIUM = new Item("ingot_niobium").setHasGlint().setHasDescription();
	public static Item NUGGET_ENDERSTEEL = new Item("nugget_endersteel").setHasGlint().setHasDescription();
	public static Item NUGGET_ENDERSTEEL_DARK = new Item("nugget_endersteel_dark").setHasDescription();
	public static Item NUGGET_NIOBIUM = new Item("nugget_niobium").setHasGlint().setHasDescription();
