...
public class RecipeShaped extends Recipe implements IShapedRecipe {
	...
	public RecipeShaped (ResourceLocation group, @Nonnull ItemStack result, ShapedPrimer primer) {
		this.group = group;
		output = result.copy();
	...
	public static class Factory implements IRecipeFactory {
		...
		public IRecipe parse (JsonContext context, JsonObject json) {
			...
			RecipeShaped result = new RecipeShaped(group
				.isEmpty() ? null : new ResourceLocation(group), output, primer);
			if (!override.isEmpty()) {
