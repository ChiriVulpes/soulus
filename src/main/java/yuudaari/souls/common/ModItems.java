...
public class ModItems {
	...
	public static ModItem[] items = new ModItem[] { BARK, BLOOD_CRYSTAL, BONE_CHUNK_ENDER, BONE_CHUNK_NETHER,
			BONE_CHUNK_NORMAL, BONE_ENDER, BONE_NETHER, BONEMEAL_NETHER, BONEMEAL_ENDER, DUST_ENDER_IRON, DUST_IRON,
			GEAR_BONE_ENDER, GEAR_BONE, GEAR_BONE_NETHER, GEAR_BONE_DRY, GEAR_BONE_FROZEN, GEAR_BONE_FUNGAL,
			GEAR_OSCILLATING, EMERALD_BURNT, EMERALD_COATED, ESSENCE, GLUE, INGOT_ENDERSTEEL, NUGGET_ENDERSTEEL,
			ORB_MURKY, SLEDGEHAMMER, SOULBOOK, BONE_SCALE, BONE_DRY, BONE_FROZEN, BONE_FUNGAL, BONE_CHUNK_DRY,
			BONE_CHUNK_FROZEN, BONE_CHUNK_FUNGAL, BONE_CHUNK_SCALE };
