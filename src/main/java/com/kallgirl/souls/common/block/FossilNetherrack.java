...
public class FossilNetherrack extends Block {
	public FossilNetherrack () {
		super("fossilNetherrack", new Material(MapColor.NETHERRACK));
		setHasItem();
		setHardness(0.4F);
	...
	public List<ItemStack> getDrops (IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		ItemStack boneChunk = ModObjects.get("boneChunkNether").getItemStack(4);
